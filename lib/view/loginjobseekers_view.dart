...
class LoginJobseekersView extends StatefulWidget {
  const LoginJobseekersView({super.key});

  @override
  State<LoginJobseekersView> createState() => _LoginJobseekersViewState();
}

class _LoginJobseekersViewState extends State<LoginJobseekersView> {
                ...
                ElevatedButton(
                  onPressed: () {
                    Navigator.push(
                      context,
                      MaterialPageRoute(
                          builder: (context) => const SignupJobseekersView()),
                    );
                  },
                  style: ElevatedButton.styleFrom(
